        ...
        <section className='max-w-[600px] w-full p-4 sm:p-8 rounded-xl bg-white border-2 border-gray-200'>
            ...
            <div className='mb-6'>
                <div className='flex justify-between items-center mb-4'>
                    ...
                    <span className='bg-blue-100 text-sm text-blue-800 px-4 py-1 rounded-full font-medium'>
                ...
                <div className='bg-gray-50 p-6 rounded-lg'>
                    <h3 className='text-md sm:text-xl font-bold mb-4'>Your Snipe Benefits</h3>
                    <ul className='space-y-3 text-sm sm:text-md'>
                        <li className='text-gray-600'>• Track up to {userCurrentTier?.maxSnipedCourses} courses</li>
                        <li className='text-gray-600'>• {userCurrentTier?.messagingMethod}</li>
                    </ul>
                </div>
            </div>
